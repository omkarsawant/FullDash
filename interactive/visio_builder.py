...
def get_visio_template_name(site_record, router_records):
    if site_record.signal_present_core:
        pass  # TODO: implement
    else:
        if site_record.router == Site.RouterChoices.ISR_4331:
            return 'small.vsdx'
        else:
            return 'medium-1.vsdx'
